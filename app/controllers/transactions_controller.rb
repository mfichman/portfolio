class TransactionsController < SimpleController
  ...
  before_action :set_accounts, only: [:edit, :create, :update, :new, :batch_new, :batch_create]
  before_action :set_assets, only: [:edit, :create, :update, :new, :batch_new, :batch_create]
